...
const lunsjRetter: LunsjRett[] = [
  {
    navn: "Chilli con torsk",
    allergener: ["fisk"],
    antallGangerServert: 3,
    verdensKjøkken: "MEKSIKANSK",
    isSuppe: false,
    fiskeArt: FiskArtType.TORSK,
  },
  {
    navn: "Soppgrateng",
    allergener: ["gluten"],
    antallGangerServert: 2,
    verdensKjøkken: "FRANSK",
    isMedBønner: false,
    antallGrønnsaker: 1,
  },
  {
    navn: "Bergens fiskesuppe",
    allergener: ["fisk", "skalldyr", "gluten"],
    antallGangerServert: 5,
    verdensKjøkken: "NORSK",
    isSuppe: true,
    fiskeArt: FiskArtType.SEI,
  },
  {
    navn: "Fiskekaker med ovnsbakte grønnsaker",
    allergener: ["fisk", "nøtter"],
    antallGangerServert: 10,
    verdensKjøkken: "NORSK",
    isSuppe: false,
    fiskeArt: FiskArtType.HYSE,
  },
  {
    navn: "Tikka Masala",
    allergener: ["laktose", "nøtter"],
    antallGangerServert: 10,
    verdensKjøkken: "INDISK",
    kjøtt: "KYLLING",
  },
  {
    navn: "Loaded veggie nachos",
    allergener: [],
    antallGangerServert: 2,
    verdensKjøkken: "MEKSIKANSK",
    isMedBønner: true,
